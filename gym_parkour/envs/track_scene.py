...
class TrackScene(Scene):
    ...
    def episode_restart(self, bullet_client):
        ...
        if not self.starting_ground_loaded:
            ...
            self.ground_plane_mjcf = self._p.loadURDF(track_filename, useFixedBase=1, basePosition=(0, 0, -1.5), baseOrientation=(-1, 0, 0, -1))
        ...
        if not self.track_loaded:
            ...
            self._p.loadURDF(track_filename, useFixedBase=1, basePosition=(1.5, 0, -1.5), baseOrientation=(-1, 0, 0, -1))
